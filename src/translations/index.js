const translations = {
  en: {
    ...
    monitorDashboard: {
      ...
      biomassPerformance: "BSFL HEALTHINESS",
      ...
      solarGeneration: "SOLAR VOLTAGE",
      dailyGhgReduction: "DAILY GHG REDUCTION",
      weeklyGhgReduction: "WEEKLY GHG REDUCTION",
      accumulatedGhgReduction: "ACCUMULATED GHG REDUCTION",
  ...
  zh: {
    ...
    monitorDashboard: {
      ...
      systemUsage: "馬達使用量",
      solarGeneration: "太陽能電壓",
      dailyGhgReduction: "每日減碳量",
      weeklyGhgReduction: "每週減碳量",
      accumulatedGhgReduction: "總累積減碳量",
      historyData: "歷史數據",
      weightTrend: "容器重量趨勢",
      days7: "7 天",
      days15: "15 天",
